...
class inputClass:
	def __init__(self,flist,params): 
		...
		if iprint: print(__file__.split("/")[-1],"numRawChannels",numRawChannels,"shiftRatio",shiftRatio,"sampleRate",sampleRate,"lowcut",lowcut,"highcut",highcut,"secondPerFrame",secondPerFrame,"stateStep",self.stateStep)
		
		self.proc = procSegment(numRawChannels,shiftRatio,sampleRate,lowcut,highcut,secondPerFrame,self.params)
